...
dbusservice = VeDbusService('com.victronenergy.solarcharger.epever_ttyUSB3')
#
...
try:
    ...
    dbusservice.add_path('/ProductName', 'Epever Tracer 3210N XDS')
    ...
    print ("Json mppt schema has been created before!")
...
try:
    ...
    print ("Json mppt values created before!2")
